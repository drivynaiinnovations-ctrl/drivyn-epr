...
const SERVICES_DATA = {
  "drain-cleaning": {
    ...
    faq: [
      ...
      { q: "Can you clear drains same day?", a: "Yes — we offer same-day drain cleaning throughout Southern Maryland. Call (605) 815-1039 and we'll get a tech to you fast." },
  ...
  "water-heater": {
    ...
    description: "Water heater repair, replacement & installation in La Plata & Southern Maryland. Tank & tankless, same-day service. Licensed plumbers — call (605) 815-1039.",
  ...
  "pipe-repair": {
    ...
    description: "Burst pipe repair, leak detection & whole-house repiping in La Plata & Southern Maryland. Fast emergency response. Licensed plumbers — call (605) 815-1039.",
  ...
  "toilet-repair": {
    ...
    description: "Emergency toilet repair, leaking toilet fix & toilet installation in La Plata, Waldorf & Southern Maryland. Priority dispatch — call (605) 815-1039.",
    ...
    faq: [
      { q: "Is a leaking toilet an emergency?", a: "Yes — a toilet leaking at the base or running constantly can waste hundreds of gallons daily and cause floor damage. Call EPR at (605) 815-1039 for priority dispatch." },
  ...
  "garbage-disposal": {
    ...
    description: "Garbage disposal repair, replacement & installation in La Plata & Southern Maryland. All brands, same-day service. Licensed plumbers — call (605) 815-1039.",
  ...
  "emergency-service": {
    ...
    description: "24/7 emergency plumber in La Plata, Waldorf & Southern Maryland. Burst pipes, flood response, sewer backup — fast dispatch, higher rate after 3pm. Call (605) 815-1039.",
  ...
  "inspection-prevention": {
    ...
    description: "Pre-purchase plumbing inspections, backflow testing & preventive maintenance in La Plata & Southern Maryland. Licensed plumbers — call (605) 815-1039.",
