...
// â”€â”€ Service data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const SERVICES_DATA = {
  "drain-cleaning": {
    name: "Drain Cleaning",
    icon: Droplets,
    title: "Drain Cleaning Services in La Plata & Southern Maryland | EPR Plumbing",
    description: "Professional drain cleaning in La Plata, Waldorf & Charles County MD. Hydro-jetting, sewer snaking, clogged sinks & toilets cleared same day. Call (605) 815-1039.",
    badge: "Drain & Sewer Specialists",
    heroLine1: "Clogged Drain?",
    heroLine2: "Fixed Today.",
    heroSub: "Standing water, slow drains, and backed-up sinks â€” EPR clears the clog the same day across Southern Maryland. No runaround, no guesswork.",
    intro: "A clogged drain never waits for a good time. Whether it's a kitchen sink backing up before dinner, a shower that won't drain, or a main sewer line showing trouble, EPR Plumbing's licensed technicians respond fast with professional hydro-jetting, snaking, and camera inspection equipment to clear your drains completely â€” not just push the problem further down the line.",
    offers: [
    ...
    process: [
      { n: "01", title: "Diagnose the Block", body: "We run a camera through your line to pinpoint exactly where and what the blockage is â€” grease, roots, or debris." },
      ...
      { n: "03", title: "Clear It Completely", body: "We don't just poke a hole â€” we fully clear the line so water flows like new." },
      { n: "04", title: "Verify & Prevent", body: "Final camera pass confirms the line is clear. We'll also advise on preventing future clogs." },
    ],
    faq: [
      { q: "How long does drain cleaning take?", a: "Most drain cleanings take 1â€“2 hours. Hydro-jetting a full sewer line may take 2â€“3 hours depending on line length and severity." },
      { q: "Can you clear drains same day?", a: "Yes â€” we offer same-day drain cleaning throughout Southern Maryland. Call (605) 815-1039 and we'll get a tech to you fast." },
  ...
  "water-heater": {
    ...
    description: "Water heater repair, replacement & installation in La Plata & Southern Maryland. Tank & tankless, same-day service. Licensed plumbers â€” call (605) 815-1039.",
    badge: "Water Heater Experts Â· Same-Day Service",
    heroLine1: "No Hot Water?",
    heroLine2: "Fixed Today.",
    heroSub: "From emergency repairs to full tank replacements â€” EPR's licensed techs arrive stocked and ready to restore your hot water, fast.",
    intro: "When your water heater fails, it affects everything â€” showers, dishes, laundry. EPR Plumbing specializes in fast water heater diagnosis, repair, and same-day replacement throughout Southern Maryland. Whether you have a traditional tank, a tankless system, or an aging unit running out of time, our licensed technicians will get your hot water back on quickly and recommend the most cost-effective solution.",
    offers: [
    ...
    process: [
      { n: "01", title: "Diagnose the Problem", body: "We inspect the unit â€” thermostat, elements, valves, and tank condition â€” and tell you honestly whether repair or replacement makes sense." },
      { n: "02", title: "Repair or Replace", body: "Many repairs are handled on the spot. Replacements are done same day â€” we carry the most common tank sizes on our trucks." },
    ...
    faq: [
      { q: "How long does a water heater last?", a: "Traditional tank heaters last 8â€“12 years. Tankless units last 15â€“20 years with proper maintenance. If yours is over 10 years old and causing problems, replacement is usually more cost-effective than repair." },
      ...
      { q: "Can you replace a water heater same day?", a: "Yes. For standard tank replacements, we typically complete same-day installation throughout Southern Maryland. Call us at (605) 815-1039 to confirm availability." },
      { q: "What size water heater do I need?", a: "A 40-gallon tank works for 1â€“3 people; 50 gallons for 3â€“5. For larger households or commercial use, we'll size the unit correctly during the visit." },
  ...
  "pipe-repair": {
    ...
    description: "Burst pipe repair, leak detection & whole-house repiping in La Plata & Southern Maryland. Fast emergency response. Licensed plumbers â€” call (605) 815-1039.",
    ...
    intro: "A leaking or burst pipe can cause thousands of dollars in water damage within hours. EPR Plumbing's emergency pipe repair team responds fast throughout Southern Maryland â€” locating leaks with minimal wall damage, repairing or replacing damaged sections, and completing whole-house repiping projects when aging infrastructure needs a full upgrade. We work with copper, PVC, CPVC, and PEX pipe systems.",
    offers: [
    ...
    process: [
      { n: "01", title: "Locate the Leak", body: "We use pressure testing and leak detection equipment to pinpoint the exact source â€” even inside walls or under slabs." },
    ...
    faq: [
      { q: "What should I do if a pipe bursts?", a: "Shut off your main water valve immediately, then call EPR at (605) 815-1039. We offer emergency dispatch 24/7 across Southern Maryland." },
      ...
      { q: "How long does pipe repair take?", a: "Simple repairs take 1â€“3 hours. Slab leaks or repiping projects are planned over 1â€“3 days depending on home size." },
  ...
  "fixture-install": {
    ...
    description: "Professional faucet, sink, toilet & shower fixture installation in Southern Maryland. Licensed plumbers, clean work, no mess left behind. Call (605) 815-1039.",
    badge: "Fixture & Appliance Specialists",
    heroLine1: "New Fixtures.",
    heroLine2: "Done Right.",
    heroSub: "Faucets, sinks, showers, toilets â€” EPR installs them cleanly and correctly the first time, across Southern Maryland.",
    ...
    process: [
      ...
      { n: "04", title: "Test Thoroughly", body: "We run through every function â€” hot, cold, drainage â€” and check under-sink connections before we call it done." },
    ],
    faq: [
      { q: "Can I supply my own fixtures?", a: "Yes. EPR installs customer-supplied fixtures. Just make sure the fixture matches your existing rough-in dimensions â€” we'll confirm during scheduling." },
      { q: "How long does fixture installation take?", a: "A standard faucet or toilet replacement takes 1â€“2 hours. Full bathroom fixture packages vary by scope." },
      { q: "Do you handle full bathroom remodeling plumbing?", a: "Yes â€” EPR handles the rough-in plumbing for bathroom additions and remodels, coordinating with your contractor." },
      { q: "What brands do you work with?", a: "We work with all major brands â€” Moen, Delta, Kohler, American Standard, Toto, and more. We can also source fixtures directly if needed." },
      { q: "Can you replace a toilet without shutting off water to the whole house?", a: "In most cases, yes â€” toilets have their own supply shut-off. We close the local valve and replace the toilet without affecting the rest of the house." },
    ],
  },
  ...
  "toilet-repair": {
    ...
    process: [
      ...
      { n: "02", title: "Prioritize Fast", body: "Toilet leaks are flagged for our fastest available tech â€” we treat them with the urgency they deserve." },
    ...
    faq: [
      { q: "Is a leaking toilet an emergency?", a: "Yes â€” a toilet leaking at the base or running constantly can waste hundreds of gallons daily and cause floor damage. Call EPR at (605) 815-1039 for priority dispatch." },
      { q: "Why is my toilet leaking at the base?", a: "Usually a failed wax ring seal between the toilet and the flange. This requires removing the toilet and replacing the wax ring â€” a straightforward repair for a licensed plumber." },
      ...
      { q: "How long does a toilet replacement take?", a: "Standard toilet replacement takes 1â€“2 hours including shutoff, removal, new toilet installation, and testing." },
      { q: "Can you repair older low-flush toilets?", a: "Yes â€” we stock replacement parts for most common toilet brands and can service older models. If parts aren't available, we'll recommend a compatible upgrade." },
    ],
  },
  ...
  "sewer-line": {
    ...
    description: "Sewer line inspection, repair & replacement in La Plata & Southern Maryland. Camera inspection, hydro-jetting, trenchless options. Call (605) 815-1039.",
    badge: "Sewer Line Specialists Â· Camera Inspection",
    ...
    process: [
      { n: "01", title: "Camera Inspection", body: "We run a waterproof camera through the sewer line to see exactly what's blocking or damaging it â€” roots, grease, broken pipe, or offset joints." },
    ...
    faq: [
      ...
      { q: "How much does sewer line repair cost?", a: "Costs range from $300â€“$600 for hydro-jetting to $3,000â€“$10,000+ for full sewer line replacement, depending on depth, length, and access. EPR gives upfront pricing before any work starts." },
      ...
      { q: "How long does sewer line replacement take?", a: "A sewer camera inspection takes 1â€“2 hours. Spot repairs are typically done in a day. Full replacements are 1â€“3 days depending on line length and access." },
      { q: "Do tree roots really break sewer lines?", a: "Yes â€” tree roots are one of the most common causes of sewer line damage in Southern Maryland. Roots infiltrate joints and cracks, then grow until they block or burst the pipe." },
    ],
  },
  ...
  "leak-detection": {
    ...
    description: "Professional water leak detection in Southern Maryland. Slab leaks, hidden pipe leaks & wall leaks found without unnecessary damage. Call (605) 815-1039.",
    badge: "Precision Leak Detection Â· Minimal Damage",
    heroLine1: "Hidden Leak?",
    heroLine2: "We'll Find It.",
    heroSub: "High water bills, wet walls, or mysterious water sounds â€” EPR locates hidden leaks precisely, with minimal damage to your home.",
    intro: "Hidden leaks are silent destroyers. Behind walls, under slabs, and in ceilings, undetected leaks cause mold, structural damage, and sky-high water bills before you ever see a drop. EPR Plumbing uses electronic leak detection, pressure testing, and thermal imaging to locate leaks precisely â€” so we open only what we need to open, and fix what actually needs fixing.",
    offers: [
    ...
    process: [
      ...
      { n: "03", title: "Targeted Access Only", body: "We open only the specific wall section, slab area, or ceiling panel needed â€” not a large exploratory hole." },
    ...
    faq: [
      { q: "How do I know if I have a hidden water leak?", a: "Check your water meter with all fixtures off â€” if it's still moving, water is escaping somewhere. Other signs include higher-than-normal water bills, warm spots on floors, or unexplained mold." },
      ...
      { q: "How accurate is leak detection?", a: "Using professional-grade equipment, we can pinpoint leaks within inches in most cases â€” dramatically reducing damage compared to exploratory opening." },
      ...
      { q: "Does insurance cover hidden leak damage?", a: "Typically yes â€” sudden and accidental water damage from hidden leaks is often covered. EPR can provide documentation for your insurance claim." },
    ],
  },
  ...
  "garbage-disposal": {
    ...
    description: "Garbage disposal repair, replacement & installation in La Plata & Southern Maryland. All brands, same-day service. Licensed plumbers â€” call (605) 815-1039.",
    ...
    faq: [
      ...
      { q: "Can garbage disposals be repaired?", a: "Jams, resets, and minor leaks can often be repaired. If the motor has failed or the unit is over 8â€“10 years old, replacement is usually more cost-effective." },
      { q: "How long does a disposal installation take?", a: "Usually 45â€“90 minutes for a standard replacement, including drain and dishwasher line connection." },
      ...
      { q: "My disposal smells bad even after cleaning â€” what's wrong?", a: "Food debris buildup inside the grinding chamber or under the splash guard is usually the cause. If cleaning doesn't help, EPR can inspect and advise on repair or replacement." },
    ],
  },
  ...
  "emergency-service": {
    ...
    description: "24/7 emergency plumber in La Plata, Waldorf & Southern Maryland. Burst pipes, flood response, sewer backup â€” fast dispatch, higher rate after 3pm. Call (605) 815-1039.",
    badge: "24/7 Emergency Dispatch Â· Fast Response",
    heroLine1: "Plumbing Emergency?",
    heroLine2: "We Come to You.",
    heroSub: "Day or night, EPR dispatches fast across Southern Maryland. We screen every call, confirm urgency, and get a licensed tech to you â€” no waiting.",
    intro: "Plumbing emergencies don't wait for business hours. EPR Plumbing provides 24/7 emergency plumbing service throughout Charles, Prince George's, Calvert, and St. Mary's Counties. We screen every after-hours call with care, confirm the nature and urgency of your situation, and dispatch a licensed technician with the right parts. Emergency slots start at 3pm â€” and we treat every one of them with the speed and professionalism they deserve.",
    offers: [
    ...
    process: [
      { n: "01", title: "Call or Book", body: "Call (605) 815-1039 or book online. After 3pm, our emergency line connects you to a live team member immediately." },
      ...
      { n: "04", title: "Fix It Tonight", body: "Our tech arrives, resolves the emergency, and ensures your home is stable before leaving â€” no partial fixes, no callbacks." },
    ],
    faq: [
      { q: "How quickly can EPR respond to an emergency?", a: "We aim for fast dispatch across Southern Maryland. Response times depend on your location and current call volume â€” we'll give you an honest ETA when you call." },
      { q: "Is there an extra charge for emergency service?", a: "Yes â€” after-hours emergency slots (3pm onwards) carry a higher rate. We're transparent about this upfront when you call, before any work begins." },
      { q: "What counts as a plumbing emergency?", a: "Burst pipes, active flooding, sewer backups into the home, no water supply, and toilet leaks with water on the floor are all true emergencies. If you're unsure, call us â€” we'll help you decide." },
      ...
      { q: "Do you prioritize toilet leaks?", a: "Yes â€” toilet leaks are flagged for priority dispatch at EPR. Water at the base of a toilet can cause significant floor damage quickly, so we treat it urgently." },
    ],
  },
  ...
  "inspection-prevention": {
    ...
    description: "Pre-purchase plumbing inspections, backflow testing & preventive maintenance in La Plata & Southern Maryland. Licensed plumbers â€” call (605) 815-1039.",
    badge: "Inspections & Preventive Maintenance",
    heroLine1: "Catch Problems",
    heroLine2: "Before They Start.",
    heroSub: "Pre-purchase inspections, backflow testing, and preventive maintenance across Southern Maryland â€” EPR keeps your plumbing healthy year-round.",
    ...
    process: [
      { n: "01", title: "Schedule & Scope", body: "We discuss what you need â€” full home inspection, backflow test, or targeted evaluation â€” and schedule at your convenience." },
    ...
    faq: [
      ...
      { q: "How long does a plumbing inspection take?", a: "A thorough residential inspection takes 1.5â€“2.5 hours. Commercial inspections vary by property size and complexity." },
      ...
      { q: "How often should I have my plumbing inspected?", a: "For older homes (30+ years), annual inspection is smart. For newer construction, every 2â€“3 years is sufficient unless you notice a problem." },
      { q: "Can you provide documentation for insurance or code compliance?", a: "Yes â€” EPR provides written inspection reports, backflow test certificates, and compliance documentation for insurance, property sales, and regulatory requirements." },
    ],
  },
} as const;
...
// â”€â”€ Route â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ FAQ Item â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          ...
          <Reveal>
            <div className="mt-10 text-center">
              <p className="text-muted-foreground mb-4">Recognizing any of these? Don't wait â€” call EPR now.</p>
              <a href={`tel:${PHONE}`}
          ...
          <Reveal>
            <div>
              ...
              <p className="text-white/70 leading-relaxed mb-6">
                EPR Plumbing & Remodeling is based in La Plata, MD and serves Charles, Prince George's, Calvert, and St. Mary's Counties. We're licensed, insured, and available 24 hours a day â€” with emergency dispatch for after-hours calls starting at 3pm.
              </p>
              <ul className="space-y-3">
                {["Licensed & fully insured in Maryland", "Same-day and emergency service available", "Upfront pricing â€” no surprises on your invoice", "SMS & email confirmation on every booking", "Toilet leaks flagged for priority dispatch"].map((item) => (
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8 text-center">
          <Reveal>
            ...
            <h2 className="font-display text-2xl md:text-3xl font-semibold text-charcoal mb-4">
              {svc.name} â€” Southern Maryland
            </h2>
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              EPR Plumbing provides {svc.name.toLowerCase()} services throughout {AREA} â€” and everywhere in between across Charles, Prince George's, Calvert & St. Mary's Counties.
            </p>
      ...
      <section className="py-20 bg-charcoal relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-5 lg:px-8 text-center">
          <Reveal>
            ...
            <p className="text-white/75 text-lg mb-8">Schedule online or call EPR directly â€” same-day service across Southern Maryland.</p>
