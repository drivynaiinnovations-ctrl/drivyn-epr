...
const LOCATIONS_DATA: Record<LocationSlug, LocationData> = {
  "la-plata": {
    ...
    faq: [
      { q: "Do you offer emergency plumbing in La Plata, MD?", a: "Yes — EPR Plumbing is available 24/7 for emergencies in La Plata and all of Charles County. Call (605) 815-1039 any time for same-day emergency dispatch." },
  ...
  "clinton": {
    ...
    faq: [
      { q: "Do you serve Clinton, MD for emergency plumbing?", a: "Yes — EPR Plumbing dispatches to Clinton 24/7 for burst pipes, major leaks, and other emergencies. Call (605) 815-1039 any time." },
  ...
  "prince-frederick": {
    ...
    faq: [
      ...
      { q: "How quickly can you get to Prince Frederick for an emergency?", a: "EPR typically reaches Prince Frederick within 60–120 minutes for emergency calls. Call (605) 815-1039 any time, day or night." },
  ...
  "lexington-park": {
    ...
    faq: [
      ...
      { q: "What's the fastest way to get plumbing help in Lexington Park?", a: "Call (605) 815-1039 directly — our dispatch team will confirm availability and give you an accurate ETA for Lexington Park." },
  ...
  "brandywine": {
    ...
    faq: [
      ...
      { q: "How quickly can you respond to a plumbing emergency in Brandywine?", a: "We typically reach Brandywine within 60–90 minutes for urgent calls. Call (605) 815-1039 any time for emergency dispatch." },
  ...
  "northern-virginia": {
    ...
    description: "Licensed plumbers serving Northern Virginia 24/7 — Arlington, Alexandria, Fairfax, Falls Church & more. Drain cleaning, water heaters, pipe repair, emergency service. Call (605) 815-1039.",
