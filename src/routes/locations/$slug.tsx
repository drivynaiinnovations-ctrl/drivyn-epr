...
const LOCATIONS_DATA: Record<LocationSlug, LocationData> = {
  "la-plata": {
    ...
    description: "Licensed plumbers in La Plata, MD serving Charles County 24/7. Drain cleaning, water heaters, pipe repair, emergency service. Call (605) 815-1039 for same-day service.",
    badge: "La Plata, MD Â· Charles County Headquarters",
    heroLine1: "La Plata's Trusted",
    heroLine2: "Plumbing Team.",
    heroSub: "EPR Plumbing is headquartered right here in La Plata. When you need a licensed plumber fast, we're already in your neighborhood â€” 24/7, no dispatching delays.",
    ...
    faq: [
      { q: "Do you offer emergency plumbing in La Plata, MD?", a: "Yes â€” EPR Plumbing is available 24/7 for emergencies in La Plata and all of Charles County. Call (605) 815-1039 any time for same-day emergency dispatch." },
      { q: "How fast can a plumber arrive in La Plata?", a: "Because we're headquartered in La Plata, our response times are among the fastest in the area â€” typically within 60â€“90 minutes for urgent calls." },
  ...
  "waldorf": {
    ...
    description: "Licensed plumbers serving Waldorf, MD 24/7. Fast response for drain cleaning, water heaters, pipe repair, and emergency plumbing in Charles County. Call (605) 815-1039.",
    badge: "Waldorf, MD Â· Charles County",
    heroLine1: "Waldorf Plumbing",
    heroLine2: "Done Right, Fast.",
    heroSub: "EPR Plumbing serves Waldorf homeowners and businesses with fast, licensed plumbing â€” from routine drain cleaning to after-hours burst pipe emergencies.",
    intro: "Waldorf is Charles County's largest community, and EPR Plumbing is one of its most trusted service providers. We handle everything from clogged kitchen drains to complete water heater replacements â€” with upfront pricing, licensed technicians, and same-day availability when you need it most.",
    nearbyAreas: ["La Plata", "White Plains", "Brandywine", "Accokeek", "Clinton"],
    faq: [
      { q: "Do you offer same-day plumbing in Waldorf, MD?", a: "Yes. EPR Plumbing offers same-day service in Waldorf for most plumbing needs. Call (605) 815-1039 and we'll confirm your slot." },
      { q: "Can you fix a clogged drain in Waldorf today?", a: "Absolutely. Drain cleaning is one of our most common calls in Waldorf. We use professional-grade equipment to clear blockages completely â€” not just temporarily." },
  ...
  "clinton": {
    ...
    description: "Licensed plumbers in Clinton, MD (Prince George's County) available 24/7. Drain cleaning, water heaters, leak detection, pipe repair. Call (605) 815-1039 for fast service.",
    badge: "Clinton, MD Â· Prince George's County",
    heroLine1: "Clinton's Go-To",
    heroLine2: "Plumbing Crew.",
    heroSub: "EPR Plumbing serves Clinton, MD with licensed, insured technicians ready for any plumbing job â€” emergency or planned. Same-day available, 24/7 emergency dispatch.",
    intro: "Clinton homeowners know that plumbing problems don't keep business hours. EPR Plumbing brings the same fast, professional service to Clinton that we're known for across Southern Maryland â€” with upfront pricing, licensed techs, and zero hidden fees. From leak detection to water heater installs, we've got Clinton covered.",
    nearbyAreas: ["Fort Washington", "Brandywine", "Waldorf", "Oxon Hill", "Temple Hills"],
    faq: [
      { q: "Do you serve Clinton, MD for emergency plumbing?", a: "Yes â€” EPR Plumbing dispatches to Clinton 24/7 for burst pipes, major leaks, and other emergencies. Call (605) 815-1039 any time." },
      { q: "How much does a plumber cost in Clinton, MD?", a: "Pricing depends on the job. EPR provides upfront quotes before any work begins â€” no surprise charges. Standard drain cleaning typically starts around $100â€“$200 in Clinton." },
  ...
  "fort-washington": {
    ...
    description: "Licensed plumbers serving Fort Washington, MD 24/7. Drain cleaning, water heaters, pipe repair, leak detection in Prince George's County. Call (605) 815-1039.",
    badge: "Fort Washington, MD Â· Prince George's County",
    heroLine1: "Fort Washington Plumbing",
    heroLine2: "Fast & Licensed.",
    heroSub: "EPR Plumbing serves Fort Washington with licensed technicians, upfront pricing, and 24/7 emergency availability â€” from routine maintenance to urgent pipe repairs.",
    intro: "Fort Washington sits at the crossroads of Prince George's and Charles Counties, and EPR Plumbing is positioned to serve it well. Our technicians are familiar with the homes, infrastructure, and neighborhoods of Fort Washington â€” from the older communities along the Potomac to newer subdivisions off Old Fort Road. We bring the same professional standard to every call.",
    ...
    faq: [
      ...
      { q: "What's the fastest way to get a plumber in Fort Washington?", a: "Call (605) 815-1039 directly for the fastest response. For non-emergencies, you can also book online through our website." },
      ...
      { q: "Can EPR handle older homes in Fort Washington?", a: "Absolutely. We work with older plumbing systems including galvanized pipe, cast iron drain lines, and outdated fixtures â€” common in Fort Washington's established neighborhoods." },
  ...
  "prince-frederick": {
    ...
    description: "Licensed plumbers serving Prince Frederick and Calvert County 24/7. Drain cleaning, water heater install, pipe repair, sewer line service. Call (605) 815-1039.",
    badge: "Prince Frederick, MD Â· Calvert County",
    heroLine1: "Calvert County's",
    heroLine2: "Trusted Plumbers.",
    heroSub: "EPR Plumbing serves Prince Frederick and all of Calvert County with licensed, insured technicians available 24/7 â€” fast response, fair pricing, no surprises.",
    ...
    faq: [
      ...
      { q: "How quickly can you get to Prince Frederick for an emergency?", a: "EPR typically reaches Prince Frederick within 60â€“120 minutes for emergency calls. Call (605) 815-1039 any time, day or night." },
  ...
  "lexington-park": {
    ...
    description: "Licensed plumbers serving Lexington Park and St. Mary's County 24/7. Drain cleaning, water heaters, pipe repair, emergency plumbing. Call (605) 815-1039.",
    badge: "Lexington Park, MD Â· St. Mary's County",
    ...
    intro: "Lexington Park is a growing community in St. Mary's County, home to military families, government contractors, and long-time Southern Maryland residents. EPR Plumbing understands the unique needs of this community â€” fast, reliable service with the discretion and professionalism that comes standard on every job. We're proud to serve NAS Patuxent River personnel and the surrounding area.",
    ...
    faq: [
      ...
      { q: "What's the fastest way to get plumbing help in Lexington Park?", a: "Call (605) 815-1039 directly â€” our dispatch team will confirm availability and give you an accurate ETA for Lexington Park." },
  ...
  "brandywine": {
    ...
    description: "Licensed plumbers serving Brandywine, MD 24/7. Fast drain cleaning, water heater service, pipe repair, and emergency plumbing in Prince George's County. Call (605) 815-1039.",
    badge: "Brandywine, MD Â· Prince George's County",
    heroLine1: "Brandywine Plumbing",
    heroLine2: "When You Need It.",
    heroSub: "EPR Plumbing covers Brandywine with same-day service, licensed technicians, and 24/7 emergency availability â€” because plumbing problems don't wait.",
    ...
    faq: [
      ...
      { q: "How quickly can you respond to a plumbing emergency in Brandywine?", a: "We typically reach Brandywine within 60â€“90 minutes for urgent calls. Call (605) 815-1039 any time for emergency dispatch." },
  ...
  "accokeek": {
    ...
    description: "Licensed plumbers serving Accokeek, MD 24/7. Drain cleaning, leak detection, water heater replacement, pipe repair in Prince George's County. Call (605) 815-1039.",
    badge: "Accokeek, MD Â· Prince George's County",
    heroLine1: "Accokeek Plumbing",
    heroLine2: "Local & Licensed.",
    heroSub: "EPR Plumbing serves Accokeek with experienced, licensed plumbers available 24/7 â€” from basic repairs to full emergency response. No dispatch delays, no runaround.",
    intro: "Accokeek is a quiet community on the Potomac with a mix of established homes and newer construction â€” and plumbing needs that require a provider who knows the area. EPR Plumbing brings the same professional service that Charles County and Southern Maryland trust, right to your Accokeek door. Upfront pricing, licensed techs, and a satisfaction guarantee on every job.",
    ...
    faq: [
      ...
      { q: "How do I book a plumber in Accokeek?", a: "Call (605) 815-1039 or use the online booking form on our website. We'll confirm your appointment and send SMS and email confirmation." },
  ...
  "washington-dc": {
    ...
    description: "Licensed plumbers serving Washington DC 24/7. Fast drain cleaning, water heater service, pipe repair, leak detection, and emergency plumbing. Call (605) 815-1039.",
    badge: "Washington, DC Â· 24/7 Emergency Plumbing",
    heroLine1: "Washington DC's",
    heroLine2: "Trusted Plumbers.",
    heroSub: "EPR Plumbing serves Washington DC homeowners, businesses, and government facilities with licensed, insured technicians available 24/7 â€” fast response, upfront pricing.",
    intro: "Washington DC's diverse mix of historic row houses, modern condos, and government facilities demands a plumber who can handle it all. EPR Plumbing brings Maryland-licensed expertise across the District â€” from Capitol Hill to Georgetown, Southeast to Northwest. We understand DC's unique building stock and plumbing challenges, and we respond fast when it matters most.",
    nearbyAreas: ["Georgetown", "Capitol Hill", "Anacostia", "Petworth", "Silver Spring, MD", "Bethesda, MD"],
    faq: [
      { q: "Does EPR Plumbing serve Washington DC?", a: "Yes. EPR Plumbing serves Washington DC for residential, commercial, and government plumbing. Call (605) 815-1039 for same-day and emergency service." },
      ...
      { q: "Do you offer emergency plumbing in DC?", a: "Yes â€” 24/7. Whether it's a burst pipe in the middle of the night or a sewer backup on a weekend, EPR dispatches to DC around the clock." },
  ...
  "northern-virginia": {
    ...
    description: "Licensed plumbers serving Northern Virginia 24/7 â€” Arlington, Alexandria, Fairfax, Falls Church & more. Drain cleaning, water heaters, pipe repair, emergency service. Call (605) 815-1039.",
    badge: "Northern Virginia Â· Arlington Â· Alexandria Â· Fairfax",
    heroLine1: "Northern Virginia",
    heroLine2: "Plumbing Experts.",
    heroSub: "EPR Plumbing covers Northern Virginia with licensed, insured technicians â€” serving Arlington, Alexandria, Fairfax, and beyond with 24/7 emergency availability and same-day service.",
    intro: "Northern Virginia is one of the fastest-growing regions in the country, with a wide range of homes from post-war bungalows in Arlington to modern townhomes in Fairfax. EPR Plumbing brings the same professional standard we've built in Southern Maryland right across the river â€” fast response, transparent pricing, and licensed technicians who know what they're doing.",
    ...
    faq: [
      ...
      { q: "Can I get same-day plumbing service in Northern Virginia?", a: "Yes. We offer same-day service in most of Northern Virginia. Call (605) 815-1039 early and we'll do our best to get a tech to you the same day." },
      { q: "Do you handle emergency plumbing in Northern Virginia?", a: "Yes â€” 24/7 emergency dispatch to Northern Virginia for burst pipes, major leaks, sewer backups, and other urgent plumbing situations." },
      ...
      <div className="min-h-screen bg-background text-charcoal">
        ...
        <section className="py-20 bg-charcoal text-white">
          <div className="max-w-5xl mx-auto px-5 lg:px-8">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
              {[
                { icon: Clock, title: "24/7 Availability", body: "We don't stop taking calls at 5pm. Emergencies happen at midnight â€” we're ready." },
                ...
                { icon: Star, title: "5â˜… Reputation", body: "Our reviews reflect real work done for real customers across Southern Maryland." },
                { icon: MapPin, title: "Local Coverage", body: `We know ${loc.name} and ${loc.county} â€” our response times prove it.` },
        ...
        <section className="py-20 bg-charcoal text-white text-center px-5">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-white/70 mb-8 text-lg">Call or book online â€” EPR is ready for your home, business, or facility.</p>
