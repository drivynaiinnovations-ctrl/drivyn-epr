...
const LOCATIONS_DATA: Record<LocationSlug, LocationData> = {
  "la-plata": {
    ...
    description: "Licensed plumbers in La Plata, MD serving Charles County 24/7. Drain cleaning, water heaters, pipe repair, emergency service. Call (240) 525-9592 for same-day service.",
    ...
    faq: [
      { q: "Do you offer emergency plumbing in La Plata, MD?", a: "Yes — EPR Plumbing is available 24/7 for emergencies in La Plata and all of Charles County. Call (240) 525-9592 any time for same-day emergency dispatch." },
  ...
  "waldorf": {
    ...
    description: "Licensed plumbers serving Waldorf, MD 24/7. Fast response for drain cleaning, water heaters, pipe repair, and emergency plumbing in Charles County. Call (240) 525-9592.",
    ...
    faq: [
      { q: "Do you offer same-day plumbing in Waldorf, MD?", a: "Yes. EPR Plumbing offers same-day service in Waldorf for most plumbing needs. Call (240) 525-9592 and we'll confirm your slot." },
  ...
  "clinton": {
    ...
    description: "Licensed plumbers in Clinton, MD (Prince George's County) available 24/7. Drain cleaning, water heaters, leak detection, pipe repair. Call (240) 525-9592 for fast service.",
    ...
    faq: [
      { q: "Do you serve Clinton, MD for emergency plumbing?", a: "Yes — EPR Plumbing dispatches to Clinton 24/7 for burst pipes, major leaks, and other emergencies. Call (240) 525-9592 any time." },
  ...
  "fort-washington": {
    ...
    description: "Licensed plumbers serving Fort Washington, MD 24/7. Drain cleaning, water heaters, pipe repair, leak detection in Prince George's County. Call (240) 525-9592.",
    ...
    faq: [
      ...
      { q: "What's the fastest way to get a plumber in Fort Washington?", a: "Call (240) 525-9592 directly for the fastest response. For non-emergencies, you can also book online through our website." },
  ...
  "prince-frederick": {
    ...
    description: "Licensed plumbers serving Prince Frederick and Calvert County 24/7. Drain cleaning, water heater install, pipe repair, sewer line service. Call (240) 525-9592.",
    ...
    faq: [
      ...
      { q: "How quickly can you get to Prince Frederick for an emergency?", a: "EPR typically reaches Prince Frederick within 60–120 minutes for emergency calls. Call (240) 525-9592 any time, day or night." },
  ...
  "lexington-park": {
    ...
    description: "Licensed plumbers serving Lexington Park and St. Mary's County 24/7. Drain cleaning, water heaters, pipe repair, emergency plumbing. Call (240) 525-9592.",
    ...
    faq: [
      ...
      { q: "What's the fastest way to get plumbing help in Lexington Park?", a: "Call (240) 525-9592 directly — our dispatch team will confirm availability and give you an accurate ETA for Lexington Park." },
  ...
  "brandywine": {
    ...
    description: "Licensed plumbers serving Brandywine, MD 24/7. Fast drain cleaning, water heater service, pipe repair, and emergency plumbing in Prince George's County. Call (240) 525-9592.",
    ...
    faq: [
      ...
      { q: "How quickly can you respond to a plumbing emergency in Brandywine?", a: "We typically reach Brandywine within 60–90 minutes for urgent calls. Call (240) 525-9592 any time for emergency dispatch." },
  ...
  "accokeek": {
    ...
    description: "Licensed plumbers serving Accokeek, MD 24/7. Drain cleaning, leak detection, water heater replacement, pipe repair in Prince George's County. Call (240) 525-9592.",
    ...
    faq: [
      ...
      { q: "How do I book a plumber in Accokeek?", a: "Call (240) 525-9592 or use the online booking form on our website. We'll confirm your appointment and send SMS and email confirmation." },
  ...
  "washington-dc": {
    ...
    description: "Licensed plumbers serving Washington DC 24/7. Fast drain cleaning, water heater service, pipe repair, leak detection, and emergency plumbing. Call (240) 525-9592.",
    ...
    faq: [
      { q: "Does EPR Plumbing serve Washington DC?", a: "Yes. EPR Plumbing serves Washington DC for residential, commercial, and government plumbing. Call (240) 525-9592 for same-day and emergency service." },
  ...
  "northern-virginia": {
    ...
    description: "Licensed plumbers serving Northern Virginia 24/7 — Arlington, Alexandria, Fairfax, Falls Church & more. Drain cleaning, water heaters, pipe repair, emergency service. Call (240) 525-9592.",
    ...
    faq: [
      ...
      { q: "Can I get same-day plumbing service in Northern Virginia?", a: "Yes. We offer same-day service in most of Northern Virginia. Call (240) 525-9592 early and we'll do our best to get a tech to you the same day." },
