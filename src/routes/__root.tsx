...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Southern Maryland's trusted plumbing team. Residential, commercial & government. Call (240) 525-9592." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "EPR Plumbing & Remodeling" },
      { name: "twitter:description", content: "Licensed plumbers serving Southern Maryland 24/7. Call (240) 525-9592." },
