...
export const Route = createFileRoute("/faq")({
  ...
  head: () => ({
    meta: [
      { title: "Plumbing FAQ | EPR Plumbing & Remodeling â€” Southern Maryland" },
      ...
      { property: "og:description", content: "Get straight answers to the most common plumbing questions â€” from emergencies to prevention." },
...
const EMERGENCY_STEPS = [
  {
    ...
    steps: ["Shut main water valve (clockwise)", "Turn off electricity near affected area", "Open lowest faucet to release pressure", "Take photos for insurance", "Call EPR â€” (605) 815-1039"],
  },
  {
    label: "Sewage Backup",
    steps: ["Stop ALL water use immediately", "Don't touch backed-up water", "Open windows for ventilation", "Call EPR â€” priority dispatch"],
  },
  {
    label: "Gas Smell",
    steps: ["Evacuate immediately â€” don't touch switches", "Call 911 from outside", "Call your gas company", "Call us after you're safe"],
  },
  {
    label: "Water Heater Leaking",
    steps: ["Shut cold water supply line to heater", "Turn off power (breaker or gas to pilot)", "Call EPR â€” (605) 815-1039"],
  },
  {
    label: "Frozen Pipes",
    steps: ["Open affected faucet", "Warm slowly â€” hair dryer or heating pad only", "Never use boiling water or open flame", "Check for cracks after thawing", "Call us if you can't locate the frozen section"],
  },
  {
...
const FAQ_SECTIONS: FaqSection[] = [
  {
    ...
    items: [
      {
        q: "My pipe burst â€” water is everywhere. What do I do right now?",
        a: "First, shut the main water valve immediately â€” clockwise until it stops. It's usually near the water meter, in the basement, or outside at the foundation. If water is near outlets or an electrical panel, flip the breaker for that area before touching anything. Open a faucet on the lowest floor to release remaining pressure, move valuables, take photos for insurance, and call us. Once the main valve is off, the flooding stops â€” you've handled the hard part.",
      },
      {
        q: "Sewage is coming up through my drains. What should I do?",
        a: "Your main sewer line is blocked. Stop all water use immediately â€” no flushing, no sinks, no showers. Don't use chemical drain cleaners; they won't reach the blockage and can damage pipes. Avoid contact with backed-up water, open windows to ventilate, and call us for emergency drain camera inspection and hydro-jetting. Common causes include grease buildup, tree roots, flushed wipes, or collapsed clay pipes in older homes.",
      },
      {
        q: "My water heater is leaking â€” what are the first steps?",
        a: "Turn off the cold water supply line at the top of the heater (clockwise). Then shut off the power â€” flip the breaker for electric, or turn the gas dial to 'pilot.' If it's leaking from the bottom of the tank, that's corrosion â€” that's a replacement, not a repair. If it's leaking from the pressure relief valve on the side, the valve is doing its job, but excess pressure is building up and needs diagnosis. Call us and we'll walk you through it.",
      },
      {
        q: "I have zero water anywhere in the house.",
        a: "Check your main shut-off valve first â€” it may have been accidentally bumped closed. It should be fully open (counterclockwise). Then check with neighbors to rule out a municipal outage. If it's just your home and the valve is open, you may have a break in your main water line between the street and the house. Look for wet spots or soggy patches in the yard â€” a main line break can waste thousands of gallons per day and shouldn't wait.",
      },
      {
        q: "My pipes might be frozen â€” I'm getting little or no water.",
        a: "Reduced flow during cold weather almost always means a frozen pipe. Open the faucet so water can escape as it thaws â€” even a trickle means it's working. Find the frozen section (usually an exterior wall, crawl space, or garage) and warm it slowly with a hair dryer, heating pad, or warm damp towels. Never use open flame or boiling water â€” that causes immediate bursts. After it thaws, check for drips or cracks. If found, shut the main valve and call us.",
      },
    ],
  },
  {
    ...
    items: [
      {
        q: "My faucet won't stop dripping â€” is it a big deal?",
        a: "One drip per second wastes over 3,000 gallons per year â€” it shows up on your water bill every single month. The cause is almost always a worn rubber washer or O-ring inside the faucet. Quick fix once we're in there. Let us know when you call whether it's only hot water or only cold â€” that tells us which side of the valve is failing and helps us bring the right part on the first visit.",
      },
      {
        q: "My toilet keeps running â€” I can hear water going constantly.",
        a: "That constant hiss means your toilet is wasting water nonstop â€” sometimes 200 gallons a day. It's almost always a worn flapper valve or failing fill valve. Quick test: put a few drops of food coloring in the tank. If color appears in the bowl without flushing, the flapper is leaking and needs replacing. A toilet that flushes by itself randomly ('ghost flushing') is the same issue. Don't ignore it â€” the water loss is real.",
      },
      {
        q: "My toilet is clogged and about to overflow.",
        a: "Stop flushing immediately â€” every flush adds more water. Find the valve at the base of the toilet (behind or below the tank) and turn it clockwise to cut off the water supply. Use a flange plunger â€” the one with a rubber collar that fits into the drain hole â€” and push slowly, pull back firmly. If it doesn't clear after several tries, stop and call us. Forcing it can damage the toilet. And if multiple drains are backing up at once, it's a main sewer line issue â€” a bigger problem.",
      },
      {
        q: "My sink or shower drains really slowly.",
        a: "Slow drains are the early warning sign of a bigger clog forming. In bathrooms, hair and soap scum are almost always the cause. In kitchens, grease and food particles are the culprit. A drain snake or hair-remover tool often clears a bathroom drain. For kitchens, avoid pouring grease or oil down the drain â€” it hardens inside the pipe. Warning: if two or more drains in the house are slow at the same time, that's a blockage in the main line â€” beyond any plunger or home remedy.",
      },
      {
        q: "My water pressure dropped suddenly.",
        a: "The location of the drop tells us everything. One faucet only: clogged aerator â€” the small screen at the tip of the faucet. Hot water only: sediment in the water heater or a failing pressure valve. Whole house suddenly: could be a hidden leak, damaged main line, or a failing pressure regulator. Do the meter test â€” write down the reading, use zero water for 30 minutes, check again. If the number moved, water is escaping somewhere.",
      },
      {
        q: "I have no hot water at all.",
        a: "Gas heater: check if the pilot light went out â€” many modern heaters have an ignition button on the unit. If it won't relight or you smell gas, stop and call us. Electric heater: the breaker may have tripped â€” reset it and wait 45 minutes. If it keeps tripping, that's a wiring or element issue. Tankless heater: check for an error code on the display panel. Water heaters last 8â€“12 years on average â€” if yours is in that range and struggling, we can help you weigh repair vs. replacement.",
      },
      {
        q: "My sump pump isn't working and my basement is starting to flood.",
        a: "Check that it's plugged in first â€” the outlet can come unplugged in hard-to-reach spots. Check the float â€” it can get stuck against the pit wall; gently lift it to see if the pump kicks on. Check the discharge pipe outside for freezing or blockage. If the pump hums but nothing moves, the impeller may be jammed â€” that usually means replacement. Pro tip: always keep a battery backup sump pump. Power outages and heavy rain often happen together.",
      },
      {
        q: "My pipes make a loud banging noise when I use water.",
        a: "That's 'water hammer' â€” when water flow stops suddenly, the pressure wave slams the pipe walls. Not dangerous short-term, but repeated vibration loosens fittings over time. The fix is a water hammer arrestor â€” a small device installed at the supply line of the affected fixture. If it only happens with hot water, the pipe may be rubbing against a bracket as it expands with heat â€” a different but equally easy fix.",
      },
      {
        q: "My garbage disposal stopped working or is humming but not spinning.",
        a: "A humming disposal that won't spin is jammed. Turn it off and unplug it under the sink. Find the hex (Allen) wrench slot at the bottom center of the unit and turn it back and forth to free the jam. Press the small red reset button on the bottom, plug back in, and test. Never put grease, eggshells, coffee grounds, pasta, rice, or fibrous vegetables in the disposal â€” they cause most jams and clogs. Never reach inside, even when it's off.",
      },
      {
        q: "My water bill spiked but I can't find any leak.",
        a: "A spike with no obvious cause almost always means water is escaping somewhere hidden. Check the toilet first â€” drop food coloring in the tank; color in the bowl without flushing means a leaking flapper. Do the meter test: note the reading, use zero water for 30 minutes, check again. Any movement means an active leak. Check under all sinks and behind appliances for moisture or soft flooring. If the meter confirms loss but you can't find the source, we use sound amplification equipment to locate hidden leaks without opening walls.",
      },
      {
        q: "I have white crusty buildup on my fixtures and faucets.",
        a: "That's calcium and magnesium scale from hard water. On the outside of fixtures it's cosmetic â€” a 50/50 white vinegar and water solution dissolves it; soak a cloth and wrap it around the fixture for an hour. Inside your pipes and water heater it's a bigger issue: scale reduces flow, forces appliances to work harder, and shortens their lifespan. A water softener is the long-term solution. Tankless water heaters should also be flushed annually with descaling solution â€” most manufacturers require it for warranty coverage.",
      },
      {
        q: "What can actually be flushed down the toilet?",
        a: "Two things only: human waste and toilet paper. Despite what packaging claims, 'flushable' wipes don't break down the way toilet paper does â€” they're one of the biggest causes of sewer blockages. Same goes for paper towels, cotton balls, cotton swabs, dental floss, feminine products, and medication. If you use wipes, throw them in the trash. A single main line backup caused by wipes is a costly and completely avoidable fix.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "Annual maintenance prevents most of the expensive emergency calls we get. Flush your water heater to remove sediment â€” 15 minutes once a year extends life significantly. Test all shut-off valves (sinks, toilets, water heater) â€” just a quarter turn and back to make sure they won't seize in an emergency. Check under every sink and behind every toilet for moisture or soft flooring. Clean faucet aerators and showerheads to remove mineral buildup. If you have a sump pump, pour water into the pit to confirm it kicks on. Most importantly: know where your main shut-off valve is â€” and make sure every adult in the home knows too.",
      },
      {
        q: "What is a water pressure regulator and do I need one?",
        a: "A pressure regulator (PRV) keeps your home's water pressure in a safe range â€” typically 40â€“80 PSI. High pressure feels great in the shower but hammers pipes, fittings, and appliances over time. It's one of the leading causes of premature pipe and fixture failure. If you notice banging pipes, fast-dripping faucets, or appliances wearing out quickly, a failing PRV may be the reason. A basic water pressure gauge (under $15) screws onto a hose bib â€” if your reading is above 80 PSI, call us. A PRV replacement is straightforward and protects everything in your home.",
      },
      {
        q: "My shut-off valve won't turn â€” it's stuck.",
        a: "Valves that haven't moved in years seize up with mineral buildup or corrosion â€” and this always matters most in an emergency. Don't force it with a wrench â€” too much torque can snap the valve stem. Try penetrating oil on the stem, wait 5 minutes, and gently attempt again. If it still won't move during an emergency, call the water utility â€” they can shut the street-side valve. Once the crisis is over, let us replace it. And going forward: test all shut-off valves once a year with a simple quarter turn and back.",
      },
      {
      ...
      <div className="min-h-screen bg-background text-charcoal">
        ...
        <section className="bg-charcoal text-white py-20 px-5 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-white/80 max-w-2xl mx-auto leading-relaxed mb-8">
              Straight answers to the most common plumbing questions â€” from burst pipe emergencies to annual maintenance. No fluff, no upsells.
            </p>
        ...
        <section className="py-20 bg-charcoal text-white text-center px-5">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-white/70 mb-8 text-lg">Call us directly or book online â€” our team is ready 24/7.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/#book-service"
